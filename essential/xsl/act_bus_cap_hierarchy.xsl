...
<script>
	...
	<xsl:template match="node()" mode="BusinessDomain">
                ...
                <!-- stp -->
                       ...
                       <div class="viewElement small hubElementColour0" style="width:290px;height:320px;max-height:320px">
	...
	<xsl:template match="node()" mode="BusinessCapability">
                       ...
                       <div class="viewElement viewElementCap small hubElementColour2" style="margin-left:10px;valign;width:100px;height:75px;max-height:75px">
